...
<html>
<head>
    <title>Background Checks | Welcome</title>
    <meta charset="utf-8">
...
<body>
  ...
  <div class="fund_img">
    <div class="dim"></div>
      <img src="images/backgroundcheck.jpg"></div>
  </div>
  <div class="funding_area">
    <h1>Background Checks</h1>
      <p>Are you are buyer wanting to verify your seller? Do you wish to verify
        the authenticity of your buyer? Search no further, you are in the right
        place. Register with us to run background checks on companies and exporters of interest.
</p>
  </div>
