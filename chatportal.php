...
EOF;
            ...
            while ($serow = $seret->fetchArray(SQLITE3_ASSOC)) {
                ...
                echo "<a href='chatportal.php?hash=$hash'><div class='text'><img src='$select_uimg'><p>$select_uname</p></div></a>";
            }
    }
    ?>
...
?>
    ...
    <div class="rep_area">
        <form action="chatsend.php" id="send_rep" method="post" enctype="multipart/form-data">
