...
<div class="regFormArea">
  ...
  <div class="newFormArea">
      <form action="freeformexec.php" method="post" enctype="multipart/form-data">
          ...
          <input class="full" type="email" name="uemail" id="uemail" placeholder="Email Address">
          ...
          <input type="text" class="full readonly" readonly name="regas" id="regas" value="Local Buying Agent">
          <label class="type" for="package">Package type:</label>
          <input type="text" class="full readonly" readonly name="package" id="package" value="Free Membership">
