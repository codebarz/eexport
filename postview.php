...
<div class="small_nav">
  <ul>
      ...
      <li class="typcn typcn-user" style="font-size: 30px"><p>My Account</p></li>
...
<?php echo'<a href="search.php?userid='.$userid.'"><li class="tabactive_2">Export Search Engine</li></a>';?>
