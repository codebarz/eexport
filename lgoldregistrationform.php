...
<html>
<head>
    <title>Local Buying Agents Gold Registration | Welcome</title>
    <meta charset="utf-8">
...
<div class="regFormArea">
  <div class="formInstruction">
      ...
      <p>- You have a period of 1 year to renew/upgrade your subscription.</p>
  </div>
  <div class="newFormArea">
      <form action="genformexec.php" method="post" enctype="multipart/form-data">
          ...
          <input type="text" class="full readonly" readonly name="regas" id="regas" value="Local Buying Agents">
