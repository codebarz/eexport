...
<div class="post_req">
    <form action="toibs_exec.php" method="post" enctype="multipart/form-data" id="post_form">
        ...
        <div class="comImg">
          <div class="imag">
        <div class="imgprev"><img id="imgprev" src=""></div><br>
        <label for="comimg">Upload Commodity Image 1</label><br>
        <input type="file" onchange="commoditypreview()" name="comimg" id="comimg">
      </div>
      <div class="imag">
        <div class="imgprev"><img id="imgprev_2" src=""></div><br>
        <label for="comimg_2">Upload Commodity Image 2</label><br>
        <input type="file" onchange="commoditypreview_2()" name="comimg_2" id="comimg_2">
      </div>
      </div>
        <input style="background: #f7f7f7; border: none" type="text" name="to_who" id="towho" readonly value="International Buyers">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function commodityPreview_2(input) {
            if (input.files && input.files[0]) {
                var reader = new FileReader();

                reader.onload = function (e) {
                    $('#imgprev_2').attr('src', e.target.result);
                }
                reader.readAsDataURL(input.files[0]);
            }
        }
        $('#comimg_2').change(function () {
            commodityPreview_2(this);
        });
    });
</script>
</body>
