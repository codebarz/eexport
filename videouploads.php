...
color: #fff; font-family: 'Open Sans', sans-serif; font-weight: bold; padding: 5px; font-size: 14px">
	...
	<main class="cd-main-content">
		...
		<div class="content-wrapper">
            ...
            <form action="videoupload_exec.php" method="post" enctype="multipart/form-data">
                <input type="text" name="videodes" id="videodes" placeholder="Enter Video Title">
                <input type="file" name="dvideo" id="dvideo">
                <input type="submit" name="up_vid" title="up_vid" value="Upload Video File">
            </form>
            <?php
  ...
  <source src="videos/'.$name.'" type="'.$type.'">
