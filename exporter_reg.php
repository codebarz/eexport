...
<div class="reg_btns">
    <a href="exporter_reg.php" class="reg_btns_btn shadow_in">Exporter</a>
...
<div class="row_thin">
    <p><strong style="font-size: 14px">*</strong>This package is for exporters looking to export their products.
      If you have not exported before, we recommend the <a href="#">interactive package</a>
...
<div class="row_thin_pacs">
    ...
    <div class="sub_package" style="background: #fff">
      ...
      <div class="pricing">
            <h1 style="font-size: 2em">FREE MEMBERSHIP</h1>
      </div>
        <p class="p_high">-->
            <!-- <span>&#10003;</span> Export Search Engine<br>
            <span>&#10003;</span> Commodity/Quality Control<br>
